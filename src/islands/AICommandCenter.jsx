...
export default function AICommandCenter({ agents = [] }) {
  ...
  const clearModalTrackingUrl = () => {
    ...
    pushTrackingEvent("virtual_pageview", {
      page_path: basePath,
      page_location: window.location.origin + basePath,
    });
    pushTrackingEvent("agent_modal_close", { url: window.location.origin + basePath });
  };

  const openAgentModal = (url, agentSlug) => {
    setOpenAgentUrl(url);
    updateModalTrackingUrl(agentSlug);
  };
            ...
            <div className={styles.heroLayout}>
              ...
              <div>
                ...
                <div className={styles.heroCtas}>
                  <button type="button" className={styles.ctaPrimary} onClick={handleContact}>
              ...
              <div key={agent.title} className={styles.agentCard}>
                ...
                <div className={styles.agentCardActions}>
                  <button
                    ...
                    onClick={() => openAgentModal(agent.appUrl, agent.slug)}
                  >
                  ...
                  <button
                    ...
                    onClick={() => openAgentModal(agent.videoUrl, agent.slug)}
                  >
                    <Icon name="playCircle" size={14}/> Watch Video
                  </button>
                  <span className={styles.actionDivider}>|</span>
                  <button type="button" className={styles.agentCardActionBtnMuted} onClick={handleContact}>
                    Talk to an Expert
                  </button>
                </div>
              </div>
